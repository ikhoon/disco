...
//   "example-channel"            → a channel named "example-channel" (in the default guild, else any)
//   "Example-channel/example-channel"    → "example-channel" in a server whose name matches "Example-channel"
//   "Acme/example-channel"   → spaces are fine (quote it, or leave it unquoted)
